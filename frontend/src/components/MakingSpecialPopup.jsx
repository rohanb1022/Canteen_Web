...
//         <h2 className="text-3xl font-bold mb-6">Make Dish Special</h2>
//         <form onSubmit={handleSubmit}>
//           <div className="mb-6">
//             <label className="block text-gray-700 text-lg mb-2">Extra Item Name</label>
//             <input
//               type="text"
...
// src/components/AddSpecialDishPopup.jsx
import { useState } from 'react';
...
const AddSpecialDishPopup = ({ onClose, onDishAdded }) => {
  const [dishName, setDishName] = useState('');
  const [price, setPrice] = useState('');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        toast.success('Special dish added successfully!');
        onDishAdded(response.data.dish);
        ...
        // Close popup after 3 seconds of confetti animation
        setTimeout(() => {
